...
public class Lesson2 { 
	public static void main (String[] args) { 
		...
		for(int i=10;i <= 40;i = i + 10){
			if(i == 30){
				continue; //continue resets reiteration back to the beginning, skipping the rest if the iteration
			}
			System.out.println(i);
		} // output = 10,20,40
		 ...
		 * 
		 * remember when using objects rather than variables these operators will compare the memory ref rather than contents
		 */
